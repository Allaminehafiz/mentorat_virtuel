...
import com.mentorat_virtuel.projet_mentorat_virtuel.services.Mentore.MentoreService;
...
public class MentoreController {
    ...
    public ResponseEntity<Mentore> getCustomerByEmail(@PathVariable String email){
